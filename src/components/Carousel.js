    ...
    <div className="flex flex-col w-full h-auto">
        <AliceCarousel  autoPlay autoPlayInterval="2500" disableButtonsControls   >
          <div>
            ...
            <button className="w-[130px] h-[50px] bg-black border-[2px] border-solid border-[#E5BEEC] outline-none rounded-[8px] cursor-pointer text-[1.1em] text-[#E5BEEC]  font[500] ease-[0.5s] hover:bg-[#2A2F4F] hover:text-[#fff] hover:border-[#fff]">
            Register
          </button>
          </div>
          </div>
