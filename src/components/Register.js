    ...
    <div className='flex justify-center items-center min-h-screen w-full  bg-[#917FB3] bg-cover bg-no-repeat bg-center'>
      <div className=" flex relative  w-[360px] h-[600px] bg-transparent  border-[2px] border-spacing-[2px] border-solid border-black rounded-e-[20px] rounded-s-[20px]  ring-offset-30 justify-center items-center">
          <form action="#" method="get" id="form1"> 
           ...
           <h2 className='relative text-[2em] decoration-white text-white text-center' >Registation</h2>
            ...
            <div className="relative mt-[10px] mr-0 w-[300px] border-b-[1px] border-solid border-black">
              ...
              <label for="default_filledd" className="absolute text-[16px] text-white duration-300 transform -translate-y-4 scale-75 top-4  z-10 origin-[0] left-8   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-100 peer-focus:-translate-y-5">Username</label>
            </div>
            ...
            <div className="relative mt-[10px] mr-0 w-[300px] border-b-[1px] border-solid border-black">
              ...
              <label for="default_filled" className="absolute text-[16px] text-white duration-300 transform -translate-y-4 scale-75 top-4  z-10 origin-[0] left-8   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-100 peer-focus:-translate-y-5">Em@il</label>
            </div>
            ...
            <div className="relative mt-[10px] mr-0 w-[300px] border-b-[1px] border-solid border-black">
              ...
              <label for="default_fille" className="absolute text-[16px] text-white duration-300 transform -translate-y-4 scale-75 top-4  z-10 origin-[0] left-8   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-100 peer-focus:-translate-y-5">Mobile Number</label>
            </div>
            ...
            <div className="relative mt-[10px] mr-0 w-[300px] border-b-[1px] border-solid border-black">
              ...
              <label for="default_fill" className="absolute text-[16px] text-white duration-300 transform -translate-y-4 scale-75 top-4  z-10 origin-[0] left-8   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-100 peer-focus:-translate-y-5 cursor-">Create Password</label>
            </div>
            ...
            <div className="relative mt-[10px] mr-0 w-[300px] border-b-[1px] border-solid border-black">
              ...
              <label for="default_fil" className="absolute text-[16px]  text-white duration-300 transform -translate-y-4 scale-75 top-4  z-10 origin-[0] left-8   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-100 peer-focus:-translate-y-5">Conform Password</label>
            </div>
            ...
            <br />
            <button type="submit" className="w-full h-[45px] rounded-[40px] bg-black border-none outline-none cursor-pointer text-[16px] font-[500] text-white hover:text-black hover:bg-white" form="form1" value="submit">Register</button>
            <div className="text-[14.4px] text-white align-text-bottom font-[500] mt-[8px] ml-[20px] pl-[20px]">
              <p>Already have an account?<Link  href="/signin" ><span className='text-black  no-underline font-[600] hover:underline'>Login</span></Link></p>
            </div>
            </form>
      </div>
